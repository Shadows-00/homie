...
client.on("channelDelete", async channel => {
  let kanalkorumakanali = channel.guild.channels.find(`id`, "780848412048359465");//LOG KANALI İD
  ...
  console.log(nice);
  if (yetkili.id === "558724274010062858") return; //ID'si Ekli Olan Kişinin Yetkisi Alınmaz Kanal Silebilir
  if (yetkili.id === "712586355342835772") return; //ID'si Ekli Olan Kişinin Yetkisi Alınmaz Kanal Silebilir
  if (yetkili.id === "544220935947943967") return; //ID'si Ekli Olan Kişinin Yetkisi Alınmaz Kanal Silebilir
  if (yetkili.id === "644623271362560010") return; //ID'si Ekli Olan Kişinin Yetkisi Alınmaz Kanal Silebilir
      channel
  ...
  let embed = new Discord.RichEmbed()
    .setColor('BLACK')
	  .setTitle('Homie Kanal Koruma Sistemi')
  ...
  setTimeout(function() {
    channel.guild.members.get(yetkili.id).addRole("780731214968520734"); //CEZALI ROL ID'si Eklenecek
...
client.on("roleDelete", async role => {
  let rolkanal = role.guild.channels.find(`id`, "780848412048359465");//LOG KANALI
  ...
  if (yetkili.id === "544220935947943967") return; //ID'si Ekli Olan Kişinin Yetkisi Alınmaz Kanal Silebilir
  if (yetkili.id === "644623271362560010") return; //ID'si Ekli Olan Kişinin Yetkisi Alınmaz Kanal Silebilir
  if (yetkili.id === "780754737267343390") return; //BOTUN KENDİ ID'si
  role
  ...
  setTimeout(function() {
    role.guild.members.get(yetkili.id).addRole("780731214968520734"); //CEZALI ROL ID'si Eklenecek
    rolkanal.send(embed);
  }, 2000);
});
...
client.on('roleCreate', async (role, member) => {
  let sChannel = role.guild.channels.find(`id`, "780848412048359465");//LOG KANALI
